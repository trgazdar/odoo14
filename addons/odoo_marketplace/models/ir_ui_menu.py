...
class IrUiMenu(models.Model):
    ...
    def filter_mp_seller_menus(self, menu_ids):
        ...
        menu_objs = menu_objs.filtered(lambda menu: menu.groups_id)
        visible_menus = menu_objs.ids
        visible_menus.extend((
            self.env.ref('odoo_marketplace.wk_seller_dashboard').id,
        ))
        return menu_ids
